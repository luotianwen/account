...
/---
BEGIN
  EXECUTE IMMEDIATE 'DROP SEQUENCE ${entity.entityName?upper_case}_SEQ';
EXCEPTION WHEN OTHERS THEN
    NULL;
END;
/---
CREATE SEQUENCE ${entity.entityName?upper_case}_SEQ MINVALUE 100000 MAXVALUE 999999999999999999999999 INCREMENT BY 1 NOCYCLE;
</#if>
/---
</#if>
