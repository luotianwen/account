...
<script src="styles/dwz/js/jquery-1.4.4.min.js" type="text/javascript"></script>
...
<script src="styles/highcharts/exporting.js" type="text/javascript"></script>
<script src="styles/xheditor/xheditor-zh-cn.min.js" type="text/javascript"></script>

<%if(HiConfigHolder.getPublished()){ %>
 <script src="styles/dwz/dwz.hi.min.js" type="text/javascript"></script>
<%}else{ %>
