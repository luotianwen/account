...
<div class="pageHeader" >
	<form rel="pagerForm" method="post" action="lrbview.action" onsubmit="return dwzSearch(this, '${targetType}');">
	...
	<div class="searchBar">
		<ul class="searchContent" style="height: 30px">	
			...
			<input type="hidden" name="condition.condition2"  id="condition.condition2"  value="${condition.condition2}"/>	
		...
		<iframe src="<%=path%>/report/bbzs.jsp?raq=lrb.raq&gsid=${condition.gsid}&qj=${condition.condition1}" frameborder=0 width="100%" onload="suitSelf(this)"name="rpt_frame">
