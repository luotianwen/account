...
<div class="pageHeader" >
	<form rel="pagerForm" method="post" action="xjllbview.action" onsubmit="return dwzSearch(this, '${targetType}');">
	...
	<div class="searchBar">
		<ul class="searchContent" style="height: 30px">	
		    <li >
				...
				<input type="hidden" name="condition.gsid"  id="condition.gsid"  value="${condition.gsid}"/>
					<input type="hidden" name="condition.condition11"  id="condition.condition11"  value="${condition.condition11}"/>		
		...
		<iframe src="<%=path%>/report/bbzs.jsp?raq=xjllb.raq&gsid=${condition.gsid}&qj=${condition.condition1}&jsrq=${condition.jsrq}&ksrq=${condition.ksrq}&ncrq=${condition.condition11}" scrolling='auto' frameborder=0 width="100%" onload="suitSelf(this)" name="rpt_frame">
