...
<div class="pageHeader" >
	<form rel="pagerForm" method="post" action="zzfzbview.action" onsubmit="return dwzSearch(this, '${targetType}');">
	...
	<div class="searchBar">
		...
		<iframe src="<%=path%>/report/bbzs.jsp?raq=zzfzb.raq&gsid=${condition.gsid}&qj=${condition.condition1}" frameborder=0 width="100%" onload="suitSelf(this)" name="rpt_frame">
