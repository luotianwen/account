	...
	<div class="pageFormContent" layoutH="97">
		...
		<dl>
			...
			<dd>
				...
				<input type="text" class="textInput" name="menuLink.hi_authority.authorityName" value="${menuLink.authority.authorityName}"
		...
		<dl>
			...
			<dd>
				...
				<input type="text" class="textInput required" name="menuLink.hi_menu.menuName" value="${menuLink.menu.menuName}"
									lookupGroup="menuLink" lookupName="menu" suggestClass="org.hi.base.menu.model.Menu" searchFields="menuName,description"/>
