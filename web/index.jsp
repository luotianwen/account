...
<body scroll="no">
		...
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					...
					<li ><span style="color: white;"> <ws:property value="@org.hi.framework.security.context.UserContextHelper@getOrgName()"/></span></li>
					<li><a href="j_acegi_logout">退出</a></li>
					<li><a class="hi_helper" href="helper!showHelper.action" title="" target="dialog">帮助</a></li>
				</ul>
	...
	<div id="footer">Copyright &copy; 2014 <a href="#" target="dialog">天文研发团队</a></div>
