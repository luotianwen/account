	...
	<table class="table" width="100%" layoutH="138" targetType="${targetType}">
		<thead>
			<tr>
				...
				<th orderField="privilegeProcessor" class="${pageInfo.sorterName eq 'privilegeProcessor' ? pageInfo.sorterDirection : ''}"><hi:text key="范围" entity="UserAuthority"/></th>
				<th width="90">
					<c:choose>
