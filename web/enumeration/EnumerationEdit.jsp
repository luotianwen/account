					...
					<table class="list nowrap" width="100%" itemDetail="enumeration.enumerationValues">
						...
						<tbody>
							...
							<input type="hidden" name="enumeration.enumerationValues[${enumerationValueIndex.index}].id" value="${enumerationValue.id}"/>
								...
								<td>
									<input type="text" class=" required" name="enumeration.enumerationValues[${enumerationValueIndex.index}].displayRef" value="${enumerationValue.displayRef}" size="12"/>
								</td>
								<td>
									<input type="text" class=" required" name="enumeration.enumerationValues[${enumerationValueIndex.index}].description" value="${enumerationValue.description}" size="12"/>
								</td>
